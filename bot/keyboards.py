...
management_menu_keyboard.add(button_admin_menu)
...
manage_sources_keyboard.add(button_menu)
...
сancel_transfer_wallet_button = types.InlineKeyboardButton("Отмена",
                                                           callback_data="cancel_editing_wallet")
transfer_wallet_keyboard.add(сancel_transfer_wallet_button)
...
emploee_main_menu_keyboard = types.ReplyKeyboardMarkup(resize_keyboard=True)
button_get_balance = types.KeyboardButton("📊 Баланс")
button_get_reports = types.KeyboardButton("📝 Мои отчеты")

emploee_main_menu_keyboard.add(button_get_balance, button_get_reports)
